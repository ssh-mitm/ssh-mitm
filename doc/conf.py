...
redirects = {
    ...
    # The following CVE pages were originally published at the root level
    # (docs.ssh-mitm.at/CVE-*.html) before being moved to vulnerabilities/.
    ...
    # External backlinks: NVD, GitHub Advisory (GHSA-j8px-qjm3-fx72)
