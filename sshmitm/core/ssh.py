...
class SSHForwarder(SSHBaseForwarder):
    """Transparent SSH plugin — forwards the terminal session unchanged.

    This is the base class for all SSH terminal plugins. Inherit from this class
    to implement custom SSH behaviour; override only the methods you need.
    """
