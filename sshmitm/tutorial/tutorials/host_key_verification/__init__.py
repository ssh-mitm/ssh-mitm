...
from sshmitm.tutorial._conditions import (
    TRUE,
    All,
    FingerprintState,
    PortOpen,
...
from sshmitm.tutorial._requirements import NoneAuthAccess, Requirement
...
class HostKeyVerificationTutorial(Tutorial):
    ...
    proxy_target = Web01
    victim = MaxMorgan
    requires: ClassVar[list[Requirement]] = [NoneAuthAccess(MaxMorgan, Web01)]
