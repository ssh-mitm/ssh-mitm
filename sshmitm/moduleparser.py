...
def load_module_from_entrypoint(
...
class AddArgumentMethod:
    ...
    def __call__(self, *args: Any, **kwargs: Any) -> Any:
        ...
        if (
            arg_dest
            and CONFIGFILE.has_option(self.config_section, arg_dest)
            and CONFIGFILE.get(self.config_section, arg_dest)
        ):
...
class ModuleParser(
    ...
    def add_module(self, *args: Any, **kwargs: Any) -> None:
        ...
        if default_value:
            ...
            if arg_dest and CONFIGFILE.has_option(self.config_section, arg_dest):
